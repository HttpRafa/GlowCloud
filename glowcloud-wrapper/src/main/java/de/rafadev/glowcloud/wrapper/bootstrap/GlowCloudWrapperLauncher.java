...
public class GlowCloudWrapperLauncher {
    ...
    public static void main(String[] args) {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread() {
            public void run() {
                if(GlowCloudWrapper.getGlowCloud() != null) {
                    GlowCloudWrapper.getGlowCloud().exit();
                }
            }
        });
        ...
        try {
            System.out.println(ConsoleColor.toColouredString('§', "Starting the §eGlowCloud §6Wrapper §7application§8...§7"));
